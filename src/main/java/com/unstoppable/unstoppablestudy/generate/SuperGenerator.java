...
public class SuperGenerator {
    ...
    InjectionConfig getInjectionConfig() {
        return new InjectionConfig() {
            ...
            public String outputFile(TableInfo tableInfo) {
                return getResourcePath() + "/mapper/" + path + "/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        }));
    }
    ...
    protected PackageConfig getPackageConfig() {
        return new PackageConfig()
                .setParent("com.unstoppable.unstoppablestudy")
...
//                .setSuperControllerClass("com.litb.core.controller.BasicController")
    ...
    protected DataSourceConfig getDataSourceConfig() {
        return new DataSourceConfig()
                ...
                .setUsername(com.unstoppable.unstoppablestudy.generate.YmlConfig.getValue("spring.datasource.druid." + db + ".username"))
                .setPassword(com.unstoppable.unstoppablestudy.generate.YmlConfig.getValue("spring.datasource.druid." + db + ".password"))
                .setUrl(com.unstoppable.unstoppablestudy.generate.YmlConfig.getValue("spring.datasource.druid." + db + ".url"));
    }
